...
namespace outofoffice.Migrations
{
    ...
    [Migration("20241202055017_hangfirejobs")]
    partial class hangfirejobs
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("outofoffice.Models.HangFireJobs", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("outofoffice.Models.HangFireJobs", b =>
                {
                    b.HasOne("outofoffice.Models.UserAppMessage", "UserAppMessage")
                        .WithMany("HangFireJobs")
                        .HasForeignKey("UAID")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.Navigation("UserAppMessage");
                });
